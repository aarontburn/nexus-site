...
- `package.json`: Standard [package.json](https://docs.npmjs.com/cli/v9/configuring-npm/package-json). However, this does list many commands you may be using throughout development. See the [Commands](<./3 VanillaCommands.md>) section for more information.
...
- `src/process/main.ts`: The entry point to your module and the main [Process](<../Process Overview.md>). If you move or rename this file, ensure your changes are also reflected in `src/module-info.json` (read about [module-info.json](../../API/module-info.json.md)).  
