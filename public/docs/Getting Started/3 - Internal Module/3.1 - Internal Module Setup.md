...
- `package.json`: Standard [package.json](https://docs.npmjs.com/cli/v9/configuring-npm/package-json). However, this does list many commands you may be using throughout development. See the [Commands](<./3.4 - Internal Module Commands.md>) section for more information.
...
- `src/process/main.ts`: The entry point to your module and the main [Process](<./3.2 - Internal Module Process.md>). If you move or rename this file, ensure your changes are also reflected in `module-info.json` (read about [module-info.json](../../API/module-info.json.md)).  


---
### Next Steps:
Now that you've understood how the project is laid out, visit the [Internal Process](<./3.2 - Internal Module Process.md>) guide to learn how it works.
