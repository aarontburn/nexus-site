...
- `package.json`: Standard [package.json](https://docs.npmjs.com/cli/v9/configuring-npm/package-json). However, this does list many commands you may be using throughout development. See the [Commands](./3.3%20-%20React%20Module%20Commands.md) section for more information.
...
- `src/module-info.json`: A file containing metadata and export configurations for your module. Read the [Exporting](../4%20-%20Configuration%20And%20Export.md) section for more details.
- `src/process/`: The directory containing all code and assets for the process (backend).
- `src/process/main.ts`: The entry point to your module and the main [Process](<../Process Overview.md>). If you move or rename this file, ensure your changes are also reflected in `module-info.json` (read about [module-info.json](../../API/module-info.json.md)).  
...
---
### Next Steps:
Now that you've understood how the project is laid out, visit the [Process](<../Process Overview.md>) guide to learn how it works.
